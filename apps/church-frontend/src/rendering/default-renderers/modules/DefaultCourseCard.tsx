...
import { CourseCardContract } from '@churchos/frontend-contracts';

export const DefaultCourseCard: React.FC<{ data: CourseCardContract }> = ({ data }) => {
  if (!data) return null;
  ...
  return React.createElement(
    ...
    React.createElement('div', { className: 'space-y-2' },
      ...
      React.createElement(
        ...
        React.createElement('div', null, `📚 Lessons: ${data.lessonsCount}`),
        data.durationMinutes && React.createElement('div', null, `⏱️ Duration: ${data.durationMinutes} mins`)
      )
    ),
    React.createElement(
      'a',
